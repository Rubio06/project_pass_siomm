...
import { Ala, CodCta, CodCto, IndiceRendimiento, valOperativo } from '../../../../../../interface/edicion-programa-mensual.interface';
import { EdicionProgrmaMensualService } from 'src/app/module/planing/opciones-componentes/programa-mensual-labores/services';

@Component({
    selector: 'app-explotacion-indice-rendimiento',
    imports: [ReactiveFormsModule],
    templateUrl: './indice-rendimiento-explotacion.component.html',
    styleUrls: ['./indice-rendimiento-explotacion.component.css']
})
export class IndiceRendimientoExplotacionComponent implements OnInit {
    ...
    private async loadAllData(): Promise<void> {
        ...
        const codFase = cabecera?.cod_fase || '04';
    ...
    private indiceRendimiento(): void {
        ...
        this.programaState.indiceRendimiento(nroProg, "04").subscribe({
            next: ind => {
