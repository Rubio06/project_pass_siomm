...
export const ARREGLO_BOTONES_PR_MENSUAL: BotonesInterface[] = [
    {
        ...
        color: 'bg-[#0f3d57] hover:bg-[#0b2f43]',
        bloqueo: true
    },
    {
        texto: 'Anular',
        ...
        color: 'bg-[#9a3412] hover:bg-[#7c2d12]',
        bloqueo: true
    },
    {
        texto: 'Aprobar',
        ...
        color: 'bg-[#065f46] hover:bg-[#064e3b]',
        bloqueo: true
    },
    {
        texto: 'Importar',
        ...
        color: 'bg-[#0f766e] hover:bg-[#0d5c57]'
    },
    {
        texto: 'Copiar Programa',
        accion: 'copiar',
        icono: 'M9 9h10v10H9zM5 5h10v10H5z',
        color: 'bg-[#57534e] hover:bg-[#44403c]',
        bloqueo: true
    },
    {
        texto: 'Exportar',
...
export const HEADERS_PROGRAM: string[] = [
    "Año", "Mes", "Nro\nProg", "Fecha\nEmision", "Estado", "Tratamiento",
    "Und\nEconomica", "Zona", "Contrata", "Fase", "Veta", "Nivel", "Labor",
    "Tipo\nLab.", "Ala", "Cod\nCto", "Cod\nCta", "Blocks",
    "RMR\nPiso", "RMR\nVeta", "RMR\nTecho", "Avance\nMTS",
    "Sección\nAncho", "Sección\nAltura", "TMS\nDesmonte", "TMS\nMineral", "TMS\nTotal",
    "Ancho\nMinado", "Ancho\nVeta", "Ancho\nDilucion", "Tramo\nMinable", "Nro Tram\nMin",
