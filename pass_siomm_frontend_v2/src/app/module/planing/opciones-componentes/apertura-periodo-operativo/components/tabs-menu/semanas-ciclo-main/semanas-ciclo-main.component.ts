...
export class SemanasCicloMainComponent implements OnInit {
    ...
    constructor() {
        // Escucha cambios globales en las rutas de datos para renderizar dinámicamente las semanas
        effect(() => {
    ...
    private listaEnteros() {
        ...
        this.planningService.listaEnteros(periodo.anio, periodo.mes, 'semana-ciclo-secuencia')
            .subscribe({
